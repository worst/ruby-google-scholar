  ...
  describe ".author_search_url" do
    context "when given an author name" do
      it "should give an appropriate url" do
        Google::Scholar.author_search_url("test").should == 'https://scholar.google.com/citations?view_op=search_authors&hl=en&mauthors=author%3A%22test%22'
      end
    end
    context "when given an author name with spaces" do
      it "should perform escaping" do
        Google::Scholar.author_search_url("testing this").should == 'https://scholar.google.com/citations?view_op=search_authors&hl=en&mauthors=author%3A%22testing+this%22'
      end
    end
  end
end
